...
<svelte:head><title>politica - Configuración</title></svelte:head>
<div class="space-y-4">
<div class="flex items-center justify-between">
<h2 class="text-xl font-bold">politica</h2>
<a href="/agendamiento/configuracion" class="btn btn-ghost btn-sm">← Volver</a>
</div>
<div class="card bg-base-100 shadow">
<div class="card-body">
<form method="POST" use:enhance>
<p class="mb-4">Configuración de politica del agendamiento.</p>
