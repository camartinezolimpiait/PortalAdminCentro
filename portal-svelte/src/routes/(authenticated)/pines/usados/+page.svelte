<!--
  Pines Usados
  Replaces: Pages/Pines/Usados/Usados.razor
-->
<script lang="ts">
...
goto(`/pines/usados?page=${page}&pageSize=${data.pageSize}`);
}
...
<svelte:head>
<title>Pines Usados</title>
</svelte:head>

<div class="space-y-4">
<div class="flex items-center justify-between">
<h2 class="text-xl font-bold">Pines Usados</h2>
...
emptyMessage="No se encontraron pines usados"
/>
</div>
