...
namespace portalAdministrativoSISEC.Pages.SuperTransporte.CRC
{
    public partial class Poliza
    {
        ...
        private PolizaDto _polizaDto = new PolizaDto();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            var data = await _superTransporteService.GetCentro(applicationShared.IdCentroStrappi, "poliza");
            ...
            if (context.Validate())
            {
                ...
                if (idPoliza_vigente > 0)
                {
                    ...
                    if (idSoporte_pago > 0)
                    {
                        ...
                        var resultado = await _superTransporteService.PutCentro(new PolizaDtoRequest<int, int>()
                        {
                            poliza = new PolizaCls<int, int>()
                            {
