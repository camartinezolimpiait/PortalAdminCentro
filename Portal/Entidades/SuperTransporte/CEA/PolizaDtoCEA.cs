...
namespace portalAdministrativoSISEC.Entidades.SuperTransporte.CEA
{
    ...
    public class PolizaClsCEA<T,X>
	{
        ...
        public bool ha_presentado_reclamacion { get; set; }
        public string motivo_reclamacion { get; set; }
        public T poliza_vigente { get; set; }
        public X soporte_pago { get; set; }
    }

    public class PolizaDtoRequestCEA<T,X>
	{
        public PolizaClsCEA<T,X> poliza { get; set; }
    }
