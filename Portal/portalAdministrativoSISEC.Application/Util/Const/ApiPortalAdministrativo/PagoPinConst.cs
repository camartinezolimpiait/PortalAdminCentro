...
namespace portalAdministrativoSISEC.Util.Const.ApiPortalAdministrativo
{
    public static class PagoPinConst
    {
        ...
        public static readonly Dictionary<EnumTramite, string> DescripcionTramite = new()
        {
        ...
        public static readonly Dictionary<EnumTipoDocumento, string> DescripcionDocumento = new()
        {
        ...
        public static readonly Dictionary<EnumEstadoPin, string> DescripcionEstadoPin = new()
        {
        ...
        public static readonly Dictionary<EnumOrigenCotizacion, string> DescripcionCanalVenta = new()
        {
        ...
        public static List<ColumnList> InicializarColumnasDevoluciones()
        {
            return [
                ...
                new() { NameColumn = "Código Convenio" },
                new() { NameColumn = "Empresa" },
            ];
        }

        public static List<ColumnList> InicializarColumnasActivos()
        {
            return [
                new(){ NameColumn = "Canal de Venta" },
                new(){ NameColumn = "Pin" },
        ...
        public static List<ColumnList> InicializarColumnasDispersiones()
        {
            return [
        ...
        public static List<ColumnList> InicializarColumnasAsociados()
        {
            return [
                new(){ NameColumn = "Pin" },
                new(){ NameColumn = "Tipo Documento" },
        ...
        public static List<ColumnList> InicializarColumnasAsociadosPinDirecto()
        {
            return [
                new(){ NameColumn = "Pin" },
                new(){ NameColumn = "Tipo Documento" },
        ...
        public static List<ColumnList> InicializarColumnasUsados()
        {
            return [
                ...
                new ColumnList { NameColumn = "Código Convenio" },
                new ColumnList { NameColumn = "Empresa" },
			];
        }
