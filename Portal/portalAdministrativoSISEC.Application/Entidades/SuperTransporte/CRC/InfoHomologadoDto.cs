...
{
    public class InfoHomologadoDto
    {
    ...
    public class InfoHomologadoCls<T>
    {
        public string num_contrato { get; set; }
        public string fecha_contrato { get; set; }
        public T contrato { get; set; }
    }
    public class InfoHomologadoDtoRequest<T>
    {
        public InfoHomologadoCls<T> info_homologado { get; set; }
    }
